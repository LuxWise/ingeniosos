  ...
  return (
    <Desk>
      <div className="flex items-center justify-between">
        <span className="font-semibold font-body text-4xl">Divisions</span>
      </div>
      <section className="grid grid-cols-7 w-full gap-10 mt-5">
        <div className="col-span-5">
          <table.CreateTableDivivion columns={columns} data={data} />
        </div>
        <div className="flex flex-col col-span-2 items-center justify-center w-full gap-5">
          ...
          <button.ButtonSubmit
            text="Modify"
            onSubmit={() => router.push("/ChiefCommercial/modify/divisions/")}
          />
        </div>
      </section>
    </Desk>
